...
if "mbart" in model_name:
    ...
    if args['target_lang'] == "te":
        tokenizer.tgt_lang = "te_IN"
    else:
        tokenizer.tgt_lang = "en-XX"


if model_name in ["google/mt5-base"]:
...
tokenized_datasets = raw_datasets.map(preprocess_function, batched=True, load_from_cache_file=False, remove_columns=["en", "te", "Unnamed: 0"])
...
import pickle
with open(args['output_dir']+"/test_results.txt", "wb") as f:
